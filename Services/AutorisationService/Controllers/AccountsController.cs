...
using AutorisationService.Models.Identity;
using AutorisationService.Extensions;

namespace AutorisationService.Controllers;
...
public class AccountsController : ControllerBase
{
    ...
    private readonly AutorisationDbContext _context;
    private readonly ITokenService _tokenService;
    private readonly IConfiguration _configuration;

    public AccountsController(ITokenService tokenService, AutorisationDbContext context, UserManager<User> userManager, IConfiguration configuration)
    {
